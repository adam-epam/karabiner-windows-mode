...
This fork has been modified to suit my needs, the keys table in readme has been updated accordingly.
...
Copy and paste the following URL into your browser window and Karabiner-Elements *should* ask to install the file:
    ...
    karabiner://karabiner/assets/complex_modifications/import?url=https://raw.githubusercontent.com/adam-epam/karabiner-windows-mode/master/json/windows_shortcuts.json
